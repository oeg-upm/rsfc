...
def render_template(repo_url, checks):
...
def build_assessment(repo_url):
    ...
    checks = [
        ...
        rt.test_license_info_in_metadata_files(somef_data, repo_url),
        rt.test_authors_contribs(somef_data),
        rt.test_authors_orcids(somef_data),
        rt.test_authors_roles(repo_url),
        rt.test_metadata_exists(somef_data, repo_url),
        rt.test_codemeta_exists(repo_url),
        rt.test_descriptive_metadata(somef_data),
        rt.test_title_description(somef_data),
        rt.test_has_citation(somef_data),
        rt.test_reference_publication(somef_data, repo_url),
        ...
        rt.test_metadata_record_in_zenodo_or_software_heritage(somef_data, repo_url),
        rt.test_id_presence_and_resolves(somef_data),
        rt.test_id_associated_with_software(somef_data, repo_url),
